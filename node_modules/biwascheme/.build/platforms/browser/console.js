...
BiwaScheme.Port.current_error = BiwaScheme.Port.current_output = new BiwaScheme.Port.CustomOutput(function (str) {
  var console;
  var text;
  console = $("#bs-console");
  if (console[0]) {
...
Console.p = function () /*ARGS*/{
  BiwaScheme.Port.current_output.put_string("p> " + _.map(_.toArray(arguments), BiwaScheme.inspect).join(" "));
};