...
(function () {
  //local namespace
  // Find the script tag
  var find_script_tag = function find_script_tag(e) {
    if (e.nodeName.toLowerCase() == 'script') {
      return e;
    } else if (e.id == '_firebugConsole') {
      if (e.previousSibling.nodeName.toLowerCase() == 'script') return e.previousSibling;else console.error("BiwaScheme could not find the script tag... please use firebug 1.5.0");
    } else {
  ...
  var script_tag = function script_tag(path) {
