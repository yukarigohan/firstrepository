...
<html lang="en">
  ...
  <body>
    ...
    <div id="content">
<h2 id="faq">FAQ</h2>
<h3 id="q-does-biwascheme-has-lisp-macro-">Q. Does BiwaScheme has Lisp macro?</h3>
<p>It does not have <code>syntax-rules</code> nor <code>syntax-case</code>, but has <code>define-macro</code>.</p>
<h3 id="q-does-biwascheme-has-first-class-continuation-call-cc-">Q. Does BiwaScheme has first-class continuation (call/cc)?</h3>
<p>Yes. But note that <code>dynamic-wind</code> is not supported yet.</p>
<h3 id="q-can-i-use-biwascheme-on-node-">Q. Can I use BiwaScheme on Node?</h3>
<p><a href="/doc/getting_started.html#nodejs">Yes.</a></p>
    </div>
