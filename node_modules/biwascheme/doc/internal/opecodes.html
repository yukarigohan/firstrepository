...
<li><a href="#op_nuate">op_nuate</a> : Invoke continuation</li>
...
<pre><code>[frame
   ...
   [apply]]]]]]
[halt]]
</code></pre><h3 id="op_argument">op_argument</h3>
<p><a name="op_argument" /></p>
...
<pre><code>[frame
   ...
   [apply]]]]]]
[halt]]
</code></pre><h3 id="op_test">op_test</h3>
<p><a name="op_test" /></p>
...
[test
   ...
   [constant 9
      [halt]]]]
</code></pre><h3 id="op_close">op_close</h3>
<p><a name="op_close" /></p>
<p>Create Scheme closure object (which is represented with JS Array).</p>
<h4 id="format">format</h4>
<pre><code>[&quot;close&quot;, &lt;n&gt;, &lt;body&gt;, &lt;opecodes_next&gt;, &lt;dotpos&gt;]
</code></pre><p>TODO: &lt;opecodes_next&gt; should be the last in consistency with other opecodes</p>
...
<pre><code>[close 
  ...
  [halt]
  -1]
</code></pre><h4 id="example-of-reassigned-freevars">example of reassigned freevars</h4>
...
</code></pre><p>But when the freevar may reassigned by set!, a box (JS array contains the actual value) is stored. It will be unboxed by op_indirect (see also: op_indirect, op_box)</p>
<pre><code>(define (f a b)
  (set! a 99)
  (lambda () a b))
(f 11 22)
...
</code></pre><h3 id="op_conti">op_conti</h3>
<p><a name="op_conti" /></p>
<p>Capture the current continuation.</p>
<p>Caputred continuation is just a Scheme closure which includes whole copy of current stack and op_nuate to restore it (see also: op_nuate).</p>
<h4 id="format">format</h4>
<pre><code>[&quot;conti&quot;, &lt;n&gt;, &lt;opecodes_next&gt;]
</code></pre><p>n: number of args(for outer lambda) to remove (= 0 unless tail position)</p>
<h4 id="example">example</h4>
<p>program:</p>
...
<pre><code>[frame
   ...
   [apply]]]]]]
[halt]]
</code></pre><h3 id="op_nuate">op_nuate</h3>
<p><a name="op_nuate" /></p>
<p>Restore stack saved by op_conti (see op_conti).</p>
<h4 id="format">format</h4>
<pre><code>[&quot;nuate&quot;, &lt;saved_stack&gt;, &lt;opecodes_next&gt;]
...
[return]]]
</code></pre><h3 id="op_halt">op_halt</h3>
<p><a name="op_halt" /></p>
...
<pre><code>[constant ()
  [halt]]
</code></pre><h3 id="op_frame">op_frame</h3>
<p><a name="op_frame" /></p>
...
[halt]]
</code></pre><p>Note that op_frame itself does not touch &#39;f&#39; register. Since function arguments are evaluated between op_frame and <a href="#apply">apply</a> and these evaluations must be done in the current frame, &#39;f&#39; register is updated by <a href="#apply">apply</a>.</p>
...
[halt]]
</code></pre><h3 id="op_tco_hinted_apply">op_tco_hinted_apply</h3>
<p><a name="op_tco_hinted_apply" /></p>
<p>Same as op_apply, but used for tail calls. Added for stack trace.</p>
<h4 id="format">format</h4>
<pre><code>[&quot;tco_hinted_apply&quot;]
</code></pre><h4 id="description">description</h4>
<p>See op_apply for how it retrieves the funcion and its arguments.</p>
...
(Note that this is different from stack.length,
 because this.stack is one-dimentional array).</li>
<li>However, call_stack.length may not be the same as number of frames
because tail call does not push stack frame.</li>
<li>tco_counter holds this difference, i.e. how many funcalls have occured
...
<pre><code>[close 0                      // Create a Scheme closure
   ...
   [halt]]
-1]
</code></pre><h3 id="op_return">op_return</h3>
<p><a name="op_return" /></p>
<p>Pop stack frame.</p>
<p>op_return is generated by (lambda ...) and must be called as the last opecode of function execution.</p>
<h4 id="format">format</h4>
<pre><code>[&quot;return&quot;]
</code></pre><p>op_return does not have <opecodes_next> because it pops next opecodes from stack.</p>
<h4 id="description">description</h4>
...
<pre><code>[frame
   ...
   -1]]]
[halt]]
</code></pre><h3 id="op_shift">op_shift</h3>
<p><a name="op_shift" /></p>
...
<pre><code>(define (foo x y)
  (bar &quot;a&quot; &quot;b&quot; &quot;c&quot;))
(foo &quot;x&quot; &quot;y&quot;)
</code></pre><p>Before applying bar, op_shift removes the following values. Note that first four elements will not be popped - that&#39;s why this operation is named &quot;shift&quot;.</p>
<ul>
<li>3 //stack top</li>
...
</code></pre><p>Here (print 1) is a tail call.</p>
<p>compiled:</p>
<pre><code>[frame
   [constant 0
   [argument
   ...
   -1]]]
[halt]]
</code></pre><p>Without tail call optimization, this program is compiled to:</p>
<pre><code>[frame
   [constant 0
   [argument
   [close 0
   ...
   -1]]]
[halt]]
</code></pre><h3 id="op_refer-local">op_refer-local</h3>
<p><a name="op_refer-local" /></p>
...
<pre><code>[frame
   ...
   [close 0
      ...
      -1]]]]]
[halt]]
</code></pre><h3 id="op_refer-free">op_refer-free</h3>
<p><a name="op_refer-free" /></p>
...
<pre><code>[frame
   ...
   -1]]]]]]]
halt]
</code></pre><h3 id="op_refer-global">op_refer-global</h3>
<p><a name="op_refer-global" /></p>
...
[halt]]
</code></pre><h3 id="op_assign-local">op_assign-local</h3>
<p><a name="op_assign-local" /></p>
...
<pre><code>[frame
   ...
   -1]]]]]
halt]
</code></pre><h3 id="op_assign-global">op_assign-global</h3>
<p><a name="op_assign-global" /></p>
...
[assign-global &quot;a&quot;
[halt]]]
</code></pre><h3 id="op_box">op_box</h3>
<p><a name="op_box" /></p>
